...
// scripts.
import bool lappen_nass;
import bool packedZahnbuerste;
import bool packedMakeup;
import bool packedSchwarz;
import bool packedLila;
import bool packedRosa;
import bool packedSexy;
import bool packedKondome;
import bool packedKissen;
import int spielerPosX;
import int spielerPosY;
import bool lueftung_offen;
import bool batterie_drin;
import bool cd_drin;
...
//! veraltet (obsolet) - wird durch ein Player-Extend ersetzt (Character.GoToCharacter(Character *charac, Direction dir, bool FacePlayer, eBlockingMMM blocking);)
...
import function PlaceCharacter (this Character*, int x, int y, Direction dir);

//! veraltet (obsolet)
import function PlacePC (int x, int y, Direction dir);
...
import function any_click_move (int x, int y, Direction dir);
//! lässt den Spieler nur an die Position laufen, wenn die aktuelle Aktion 'eActWalk' ist
import function any_click_walk (int x, int y, Direction dir);
//! lässt den Spieler nur an die Position laufen, wenn die aktuelle Aktion 'eActLookat' ist
import function any_click_walk_look (int x, int y, Direction dir, String lookat);
...
import function any_click_on_door (int GI, Object *objekt, int x, int y, Direction dir, int nr_room, int nr_x, int nr_y, Direction nr_dir);
...
import function any_click_on_door_special (int GI, Object *objekt, int x, int y, Direction dir, int nr_room, int nr_x, int nr_y, Direction nr_dir, int opensound, int closesound, int key, int closevalue);
import function any_click_on_light_switch (int hotspot, int x, int y, Direction dir);
import function any_click_use_inv (int item, int x, int y, Direction dir);
...
import function any_click_walk_look_pick (int x, int y, Direction dir, string lookat, Object *object, InventoryItem *item, int GI, int sound);

//! veraltet (obsolet)
import function SetWalkTo (int x, int y, Direction dir);
//! veraltet (obsolet)
